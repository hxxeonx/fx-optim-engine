...
class Attention(nn.Module):
    def __init__(self, d_model, n_heads, d_k = None, d_v = None, 
        ...
        # Attention 객체 : Scaled Dot-Product Attention (multiple heads)
    ...
    def forward(self, Q:Tensor, K:Optional[Tensor]=None, V:Optional[Tensor]=None, prev:Optional[Tensor]=None,
        ...
        """Multi Head Attention Layer
            Input shape:
                Q:       [batch_size x q_len x d_model]
        ...
        ### Query, Key, Value 벡터 생성을 위한 Linear (+ split in multiple heads)
        ...
        # Option (1) Residual Attention (2) Basic
        # output: [bs x n_heads x q_len x d_v], 
        # attn_w: [bs x n_heads x q_len x q_len], 
